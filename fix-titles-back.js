...
const regex = /  <!-- Header: KSA Calligraphy \(center\) -->[\s\S]*?<!-- Data Table -->\n  <div style="position:absolute;top:185px;left:40px;width:714px;">/g;
...
console.log('Restored and enlarged titles, shifted table down');
