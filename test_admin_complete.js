...
const runTests = async () => {
    ...
    try {
        ...
        const owner = dbData.subscriptions['6316398194'];

        assert(owner !== undefined, 'Owner account 6316398194 exists in subscriptions.json');
        assert(owner.username.toLowerCase() === 'zakaria_2025', 'Owner username is zakaria_2025');
        ...
        const finalOwner = finalDb.subscriptions['6316398194'];
